...
export default function ExpertConsultForm({ onClose }: { onClose: () => void }) {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-lg font-bold text-gray-900">전문가 상담 신청</h2>
        <p className="mt-1 text-sm text-gray-500">담당 컨설턴트가 영업일 기준 1~2일 내 연락드립니다.</p>

        {sent ? (
          <p className="mt-6 rounded-xl bg-gray-50 p-4 text-sm text-gray-700">
